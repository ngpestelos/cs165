...
\noindent {\textbf{Answer:}} There are different categories of disk failure. One of them is what's commonly referred to as a bad sector (part of the track is unreadable). A more severe disk failure is what is called a media failure (the whole disk is unusable).
