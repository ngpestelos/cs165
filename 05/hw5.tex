...
\vskip.15in
\noindent with FDs $AB \rightarrow C$, $C \rightarrow D$, and $D \rightarrow A$
...
\vskip.45in
\noindent [3 points] 3. Consider the relation

\[R(A, B, C, D)\]

\vskip.15in
\noindent with FDs $AB \rightarrow C$, $BC \rightarrow D$, $CD \rightarrow A$, and $AD \rightarrow B$

\vskip.15in
\noindent Decompose the relation into smaller relations that are in BCNF.

\vskip.45in
\noindent [3 points] 4. Consider the relation

\[R(A, B, C, D, E)\]

\vskip.15in
\noindent with MVDs $A \rightarrow \! \! \! \! \rightarrow \; B$ and $AB \rightarrow \! \! \! \! \rightarrow \; C$ and FD $A \rightarrow B$

\vskip.15in
\noindent Decompose the relation into smaller relations that are in 4NF.
