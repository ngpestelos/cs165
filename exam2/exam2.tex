...
\vskip.10in
\noindent Given this relation for keeping a history of orders made by customers:

\begin{quote}
$Orders(custid, custname, address, telephone, email, ordernum, orderdate, itemnum, itemname, \\sellingprice, quantity)$
\end{quote}
