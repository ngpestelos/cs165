...
\[Rentals(customerID, customerName, street, city, zipcode, telephone, email, title, year, actor, genre, rentalID, rentalPrice, rentalDate, rentalLimit)\]

\vskip.15in
\noindent Decompose this relation into smaller relations, such that no data is lost when these small relations are recombined. The goal of this exercise is to keep redundancies and inconsistencies to a minimum.
